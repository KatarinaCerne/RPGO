...
r1=1;
odv_b1=bezierder(B1,r1,t1); %prvi odvod, toèke na krivulji
x1=odv_b1(:,1); %x-koordinate toèk na krivulji
y1=odv_b1(:,2);
%plot(x1,y1);

r2=2;
odv_b2=bezierder(B1,r2,t1); %drugi odvod, toèke na krivulji
x2=odv_b2(:,1);
y2=odv_b2(:,2);
%plot(x2,y2)
...
a1=[0,0];
dif_x1=factorial(n)/factorial(n-r1)*diff(B1(:,1),1)+a1(1); %x-koord. kontrolnih toèk za prvi odvod
